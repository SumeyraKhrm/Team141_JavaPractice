...
public class C01_FarkliPackageChildClass extends C02_Depo {  // Child class yapmak ıcın extends

    public static void main(String[] args) {

        //System.out.println(C02_Depo.privateStr);
        //System.out.println(C02_Depo.defaultStr);  // package dısına cıkınca default olanlarada ulasılmıyor
