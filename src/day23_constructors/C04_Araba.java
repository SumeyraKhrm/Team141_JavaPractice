...
public class C04_Araba {
    ...
    C04_Araba(){  //görünür bir sons. oluturunca daha önceden default cons. ile obje oluşturulmuş
        //olabilr sorun olmaması için ,paremetrezsiz constructor oluşturulur
    ...
    public C04_Araba(String marka, String model, int yil, int fiyat) {
        this.marka = marka; // parametre ismi ile class leveldeki instance ismi aynı ise this kull.
        this.model = model;
        this.yil = yil;
        this.fiyat = fiyat;
    }
