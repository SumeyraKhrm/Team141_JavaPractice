...
public class C02_ArabaRunner {
    ...
    public static void main(String[] args) {
         ...
         /*
            ...
            Java objeyi olusturup, olusturuldugu class'daki
            ...
            diger bir deyisle  Bir Constructor calismadan,
        ...
        // obje olusturulunca instance variablerı bir kopyası gelir

        System.out.println(araba1.fiyat);  //0
        // bir değer atanmasa bile class level dekilere java default deger atar
        System.out.println(araba1.marka);  //Marka berlirtilmedi
        System.out.println(araba1.model);  //Marka berlirtilmedi
        System.out.println(araba1.yil);   //1900


        araba1.marka="Toyata";
        araba1.model="Cooralla";
        araba1.yil=2012;
