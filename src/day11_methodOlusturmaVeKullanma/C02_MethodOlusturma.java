package day11_methodOlusturmaVeKullanma;
...
public class C02_MethodOlusturma {
    ...
    public static void main(String[] args) {
        ...
        buyukOlaniYazdir(7,8); // Sayilardan buyuk olan : 8     //method call !!!
    ...
    public static void buyukOlaniYazdir(int sayi1 , int sayi2){     //method  !!
