...
public class C02_LocalVariables {
      ...
      /*
        1- Local variable'lar bir kod blogunun icinde olusturulur
           ve scope'u icerisinde olusturuldugu kod blogudur, baska bir yerde kullanilamaz !!
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(s);  sayıyı deklare ettik fakat deger atanmadığı için yazdırılmaz
