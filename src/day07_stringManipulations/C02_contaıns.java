...
public class C02_contaıns {
    public static void main(String[] args) {
        ...
        System.out.println(str.contains("Ali")); // true (Ali içerirmi demek )
        System.out.println(str.contains("ali")); // false ( cunku kucuk buyuk fark hassasiyeti var )
        ...
        // boyle birşey istendigınde ya kucuk yada buyuk farke çevırıp bakılabilir !!!!!
