...
public class C02_MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        /*
            Bir class'da overloading varsa o method cagrildiginda,
             java hangi method'un calisacagina asagidaki 3 adimla karar verir :

            1- signature'i %100 ayni olan method varsa onu calistirir
            2- signature'i ayni olan method yoksa Java casting yaparak kullanabilecegi method arar
            3- Casting ile birden fazla method calisabiliyor ise Java en az casting yapacagi method'u tercih eder
       ...
       // toplama("ali",5); CTE ==>"ali" argumentini method'lardan hic biri parametre olarak kabul etmez
        toplama( 3.4f, 6);  //double ve integer'in toplami : 9.400000095367432
