...
public class C05_SifreOlusturma {
    ...
    public static void main(String[] args) {
        ...
        // sifre, istenen sartlara uymadigi surece kullanicidan yeni sifre istemeye devam edin,
        // istenen sartlara uygun bir sifre girildiginde "Sifreniz basariyla kaydedildi" yazdirin.

        // sifre kontrolu icin bir method olusturun
        // asagidaki sartlari kontrol edin ve kullaniciye düzeltmesi gereken
        // tüm eksikleri söyleyin eğer tüm şartları sağlarsa method true , sartlar saglanmazsa false dondurecektir
        ...
        while (!sifreSonuc){
            ...
            sifreSonuc=  sifreUygunMu(sifre);   // sıfreyı methoda yollayıp yazdırıyoruz
        }
