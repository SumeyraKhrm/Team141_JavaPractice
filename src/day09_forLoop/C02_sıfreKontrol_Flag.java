...
public class C02_sıfreKontrol_Flag {
    public static void main(String[] args) {
        ...
        String sifre = scanner.nextLine();
            ...
            + tum hatalari sirasiyla kontrol eder, en sonda hata if'lerine takilmazsa basarili sifre yazdirabiliriz
            - if else cumlelerinde, suzgec mantigi oldugundan sadece 1 hatayi yazdirabiliriz
            ...
            - bagimsiz if cumleleri kodun kendileri disindaki kismiyla ilgilenmez
              yani sifrenin basarili oldugunu yazdirabilmek icin ekstra bir kontrol mekanizmasi kullanmalisiniz
         */
