...
import day16_arrays.C05_ElemanArama;
...
public class C04_BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        C05_ElemanArama.elemanVarMı(arr,3); //Aranan sayi array'de 2 adet kullanilmistir
        C05_ElemanArama.elemanVarMı(arr,0); // Aranan eleman array'de yok
