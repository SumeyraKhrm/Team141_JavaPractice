...
public class C02_ArrayeElemanEkleme {
    ...
    public static void main(String[] args) {
        ...
        sayilar = arrayeElemanEkle(sayilar,9);     // kayıt ettik

        System.out.println("sayıların 9 eklenmiş hali " + Arrays.toString(sayilar));   // [3, 5, 7, 9]
    ...
    public static int[] arrayeElemanEkle (int[]arr, int eklencekSayi){

        // var olan bir array eyeni eleman ekleyemeyiz
